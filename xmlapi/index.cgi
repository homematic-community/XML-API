...
if {[info exists sid] && [check_session $sid]} {
  ...
  puts [subst {
    ...
    <tr><td><a href=./devicetypelist.cgi?sid=$sid>devicetypelist.cgi</a></td><td><b>Lists all possible device types with their possible meta data.<b/>
    </td></tr>
    <tr><td><a href=./exec.cgi?sid=$sid>exec.cgi</a></td><td><b>Allows to execute arbitrary ReGaHss script commands.</b><br/>
      script have to be submitted as POST data
    </td></tr>
    ...
    <tr><td><a href=./scripterrors.cgi?sid=$sid>scripterrors.cgi</a></td><td><b>Searches for the last 10 lines in /var/log/messages containing script runtime errors and outputs them.<br/>
    </td></tr>
