...
1.11
* Kompatibilit�t zu RaspberryMatic (HM-RASPBERRYMATIC) hergestellt.

1.10 als Addon
* Die XML-API kann jetzt als Addon/Zusatzsoftware �ber das WebUI installiert/deinstalliert werden 
